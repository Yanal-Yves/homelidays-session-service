...
namespace Homelidays.Web.SessionService
{
    ...
    public class SessionPersistence : ISessionPersistence
    {
        ...
        /// <summary>
        /// Request that update the session state into the data base.
        /// </summary>
        private const string UpdateStatement = "update /*A5453BDA-33AF-448b-B015-8EE3F4A7A3CD*/ [Sessions] set Data = @Data, SessionTimeOut = @SessionTimeOut, LastAccessed = GETUTCDATE() where Id = @Id";

        /// <summary>
        /// Request that just touch the session state by updating the last access date.
        /// </summary>
        private const string UpdateLastAccessedStatement = "update /*07614B4A-4224-492e-88DE-656DB7F876F3*/ [Sessions] set LastAccessed = GETUTCDATE() where Id = @Id";
        ...
        /// <summary>
        /// Initializes a new instance of the SessionPersistence class.
        /// </summary>
